...
namespace Microsoft.BotBuilderSamples
{
    ...
    public class FlightBooking : IRecognizerConvert
    {
        ...
        public class CluEntities
        {
            ...
            public CluEntity[] GetFromCityList() => Entities.Where(e => e.Category == "food").ToArray();

            public CluEntity[] GetToCityList() => Entities.Where(e => e.Category == "goodcomment").ToArray();

            public CluEntity[] GetFlightDateList() => Entities.Where(e => e.Category == "badcomment").ToArray();
