        ...
        private async Task<DialogTurnResult> ActStepAsync(WaterfallStepContext stepContext, CancellationToken cancellationToken)
        {
            ...
            switch (cluResult.GetTopIntent().intent)
            {
                case FlightBooking.Intent.order:
                    ...
                    return await stepContext.BeginDialogAsync($"What can I help you with today?");

                case FlightBooking.Intent.goodcomment:
                    // We haven't implemented the GetWeatherDialog so we just display a TODO message.
                    await stepContext.Context.SendActivityAsync($"Thank you so much!");
                    break;
                ...
                default:
                    ...
                    await stepContext.Context.SendActivityAsync($"Sorry, I didn't get that!");
                    break;
            }
